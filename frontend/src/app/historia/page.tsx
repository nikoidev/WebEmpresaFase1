...
export const metadata: Metadata = {
    title: 'Historia - SEVP | Sistema Educativo Virtual Profesional',
    description: 'Conoce la historia de SEVP, desde nuestros humildes comienzos hasta convertirnos en líderes en tecnología educativa.',
    keywords: ['SEVP', 'historia', 'trayectoria', 'evolución', 'educación digital'],
}
        ...
        <PublicLayout>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <p className="text-xl md:text-2xl text-primary-100 max-w-3xl mx-auto">
                            Un viaje de innovación, crecimiento y transformación educativa que comenzó con un sueño
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-gray-600 mb-8">
                        En 2018, un grupo de educadores y tecnólogos se unió con una misión clara: 
                        hacer que la tecnología educativa de alta calidad fuera accesible para todas 
                        las instituciones, sin importar su tamaño o presupuesto.
                    </p>
                    <p className="text-lg text-gray-600">
                        Lo que comenzó como un proyecto de fin de semana se ha convertido en la 
                        plataforma educativa más innovadora de América Latina, transformando la 
                        forma en que millones de estudiantes aprenden cada día.
                    </p>
                </div>
            </section>
            ...
            <section className="py-24 bg-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-gray-600 mb-8">
                        Estamos apenas comenzando. Nuestro objetivo para los próximos años es clara: 
                        democratizar el acceso a educación de calidad mundial para cada estudiante 
                        en América Latina y más allá.
                    </p>
                    <p className="text-lg text-gray-600 mb-8">
                        Con nuevas tecnologías como IA, realidad virtual y análisis predictivo, 
                        estamos construyendo el futuro de la educación, un estudiante a la vez.
                    </p>
