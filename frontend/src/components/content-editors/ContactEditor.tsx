...
export default function ContactEditor({ data, onChange }: ContactEditorProps) {
    ...
    const sections = [
        ...
        { id: 'contact_info', label: 'Información Principal', icon: '📞' },
        { id: 'offices', label: 'Oficinas', icon: '🏢' },
        { id: 'reasons', label: 'Motivos de Contacto', icon: '📧' }
    ]
    ...
    return (
        <div className="flex h-full">
            ...
            <div className="w-64 bg-gray-50 border-r border-gray-200 p-4">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Secciones de Contacto</h3>
            ...
            <div className="flex-1 p-6 overflow-y-auto">
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={4}
                                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                                placeholder="Ponte en contacto con nuestro equipo de expertos para resolver tus dudas o programar una demostración."
                            />
                        </div>
                    </div>
                )}
                ...
                {activeSection === 'contact_info' && (
                    <div className="space-y-6">
                        <h3 className="text-xl font-semibold text-gray-900">Información de Contacto Principal</h3>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Días de Semana</label>
                                    <input
                                        type="text"
                ...
                {activeSection === 'offices' && (
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            <h3 className="text-xl font-semibold text-gray-900">Oficinas</h3>
                            <button
                                onClick={addOffice}
                        ...
                        {formData.offices.length === 0 ? (
                            <div className="text-center py-12 bg-gray-50 rounded-lg">
                                ...
                                <p className="text-gray-500">No hay oficinas. Haz clic en "Agregar Oficina" para empezar.</p>
                            </div>
                        ) : (
                ...
                {activeSection === 'reasons' && (
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            <h3 className="text-xl font-semibold text-gray-900">Motivos de Contacto</h3>
                            <button
                        ...
                        {formData.contact_reasons.length === 0 ? (
                            <div className="text-center py-12 bg-gray-50 rounded-lg">
                                ...
                                <p className="text-gray-500">No hay motivos. Haz clic en "Agregar Motivo" para empezar.</p>
                            </div>
                        ) : (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div key={index} className="border border-gray-200 rounded-lg p-4">
                                        ...
                                        {editingReason === index ? (
                                            <div className="space-y-3">
                                                ...
                                                <div>
                                                    ...
                                                    <textarea
                                                        ...
                                                        rows={3}
                                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                                                        placeholder="Solicita una demostración o cotización personalizada"
                                                    />
                                                </div>
                                            </div>
                                        ) : (
                                            <div className="text-center">
                                                ...
                                                <span className="text-xs text-green-600">{reason.email}</span>
                                            </div>
                                        )}
                                    </div>
                                ))}
