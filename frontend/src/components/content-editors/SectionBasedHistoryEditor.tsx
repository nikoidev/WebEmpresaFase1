...
interface SectionBasedHistoryEditorProps {
    data: any
...
export default function SectionBasedHistoryEditor({ data, onChange, metaData, onMetaChange }: SectionBasedHistoryEditorProps) {
    ...
    const sections = [
        ...
        },
        {
            ...
            description: 'Hitos importantes de la empresa',
            color: 'bg-purple-500'
        },
        {
            key: 'impact',
            name: 'Números de Impacto',
        ...
        },
        {
            ...
            description: 'Planes y objetivos futuros',
            color: 'bg-red-500'
        }
    ]
    ...
    return (
        <div className="p-6">
            <div className="mb-6">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Editor por Secciones - Página Historia</h2>
