...
interface SectionBasedAboutEditorProps {
    content: any
    onChange: (content: any) => void
}

export default function SectionBasedAboutEditor({ content, onChange }: SectionBasedAboutEditorProps) {
    ...
    const sections = [
        ...
        },
        {
            key: 'values',
            name: 'Valores',
            description: 'Valores corporativos con iconos',
            color: 'bg-purple-500'
        },
        {
            key: 'team',
    ...
    return (
        <div className="p-6">
            <div className="mb-6">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Editor por Secciones - Página Nosotros</h2>
