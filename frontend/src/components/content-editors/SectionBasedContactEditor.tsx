...
interface SectionBasedContactEditorProps {
    data: any
    onChange: (data: any) => void
}

export default function SectionBasedContactEditor({ data, onChange }: SectionBasedContactEditorProps) {
    ...
    return (
        <div className="p-6">
            <div className="mb-6">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Editor por Secciones - Página Contacto</h2>
